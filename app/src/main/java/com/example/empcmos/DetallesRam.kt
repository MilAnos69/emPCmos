...
import kotlinx.android.synthetic.main.fragment_detalles_ram.*

/**
 * A simple [Fragment] subclass.
 */
class DetallesRam : Fragment() {
    ...
    override fun onCreateView(
        ...
        llenarDatos(imagen)
        return inflater.inflate(R.layout.fragment_detalles_ram, container, false)
    }
