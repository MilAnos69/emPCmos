...
import kotlinx.android.synthetic.main.fragment_detalles_disco_duro.*

/**
 * A simple [Fragment] subclass.
 */
class DetallesDiscoDuro : Fragment() {
    ...
    override fun onCreateView(
        ...
        llenarDatos(imagen)
        return inflater.inflate(R.layout.fragment_detalles_disco_duro, container, false)
    }
