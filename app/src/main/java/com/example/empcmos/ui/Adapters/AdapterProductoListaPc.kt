...
class AdapterProductoListaPc(mContext: Context?, listaProducto: ArrayList<EProducto>, private val itemSeleccionado: ItemSeleccionado) : RecyclerView.Adapter<AdapterProductoListaPc.ViewHolder>(){
